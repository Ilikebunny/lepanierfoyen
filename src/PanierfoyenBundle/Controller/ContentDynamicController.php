...
class ContentDynamicController extends Controller
{
    ...
    public function indexAction(Request $request)
    {
        ...
        list($contentDynamics, $pagerHtml) = $this->paginator($queryBuilder, $request);
        
        return $this->render('contentdynamic/index.html.twig', array(
    ...
    */
    protected function paginator($queryBuilder, $request)
    {
        ...
        {
            return $me->generateUrl('contentdynamic', array('page' => $page));
        };
    ...
    public function newAction(Request $request)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('contentdynamic_show', array('id' => $contentDynamic->getId()));
        }
        return $this->render('contentdynamic/new.html.twig', array(
    ...
    public function editAction(Request $request, ContentDynamic $contentDynamic)
    {
        ...
        return $this->render('contentdynamic/edit.html.twig', array(
            'contentDynamic' => $contentDynamic,
    ...
    public function deleteAction(Request $request, ContentDynamic $contentDynamic)
    {
        ...
        return $this->redirectToRoute('contentdynamic');
    }
    ...
    public function deleteById($id){
        ...
        return $this->redirect($this->generateUrl('contentdynamic'));
